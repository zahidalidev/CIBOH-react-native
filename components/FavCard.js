    ...
    return (            
            <View style={{flexDirection:'row', marginLeft: 5, marginRight:5}} >
                <View style={styles.feedCards} >
                    ...
                    <Text style={{fontFamily: 'ZermattFirst', fontSize:15, marginTop:5, maxWidth: 170}} >
                        {description}
                    </Text>
                    <View style={{flexDirection: 'row'}} >
                    <Text style={{fontFamily: 'sofiaprolight', fontSize:12, maxWidth: 170}} >
                        by 
                    </Text>
                    <Text style={{fontFamily: 'sofiaprolight', fontSize:12, maxWidth: 170, color: colors.primary}} >
                        {' '} {author}
                    </Text>
